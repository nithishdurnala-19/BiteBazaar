        ...
        <main className='mt-32 px-4 md:px-20 text-[#6C4B3F]'>
            ...
            <div className='md:max-w-[760px] gap-y-3 mx-auto md:gap-x-10 flex flex-col md:flex-row justify-between mt-6'>
                ...
                <div className='flex w-full md:w-[350px] items-center h-24 gap-x-3 bg-white rounded-[13px] shadow-md shadow-[#d3d1d1] px-5 py-4'>
                    ...
                    <h1 className='ml-4'>+234 000 567 816</h1>
                </div>
            </div>
            <div className='py-10 px-3 bg-white rounded-[14px] md:max-w-[760px] md:mx-auto mt-6'>
                ...
                <div className='mt-6 flex flex-col md:flex-row justify-between md:items-center md:gap-x-10'>
                    <div className='flex-1 flex flex-col gap-y-2'>
                        ...
                        <input className='border rounded-[10px] py-2 px-3 outline-[#f27957]' type='text' placeholder='Enter name ...' />
                    </div>
                    <div className='flex-1 flex flex-col gap-y-2 mt-3 md:mt-0'>
                        <label className='font-semibold'>Email</label>
                        <input className='border rounded-[10px] py-2 px-3 outline-[#f27957]' type='email' placeholder='Enter email ...' />
                    </div>
                ...
                <div className='mt-6 flex flex-col md:flex-row justify-between md:items-center md:gap-x-10'>
                    <div className='flex-1 flex flex-col gap-y-2'>
                        ...
                        <input className='border rounded-[10px] py-2 px-3 outline-[#f27957]' type='text' placeholder='Enter address ...' />
                    </div>
                    <div className='flex-1 flex flex-col mt-3 md:mt-0 gap-y-2'>
                        <label className='font-semibold'>About</label>
                        <input className='border rounded-[10px] py-2 px-3 outline-[#f27957]' type='text' placeholder='Enter about ...' />
                    </div>

                </div>
                <div className='flex flex-col mt-6 gap-y-2'>
                    <label className='font-semibold'>Message</label>
                    <textarea className='border rounded-[10px] h-32 md:h-24 py-2 px-3 outline-[#f27957]' type='text' placeholder='Enter address ...' />
                </div>
                <button className='px-4 py-3 flex mx-auto mt-6 rounded-[13px] bg-[#f27957]'>Send Message</button>
            </div>
