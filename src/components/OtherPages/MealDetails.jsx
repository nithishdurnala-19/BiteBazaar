...
const MealDetails = () => {
    ...
    return (
        <main className='mt-20 px-4'>
            ...
            <div className='py-4 px-3 gap-x-3 w-[80%] bg-[#f27957] flex items-center rounded-md mt-10 mx-auto'>
                <Link to='/'>
                    <div>
                ...
                <div className='bg-white rounded-md py-10 px-3'>
                    <div className='flex flex-col md:flex-row justify-between gap-x-10'>
                        ...
                        <div className='flex-1 flex flex-col '>
                            <h1 className='text-3xl border-b pt-6 pb-6 border-[#6C4B3F]  text-[#f27957]'>{blogDetailArray[0]?.strMeal}</h1>
                            ...
                            <button onClick={() => onAdd(blogDetailArray[0])} className='rounded-md outline-none mt-28 bg-[#f27957] px-6 py-3'>
