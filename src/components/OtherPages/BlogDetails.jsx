    ...
    return (
        <main className='mt-20 px-4'>
            <div className=' md:px-10 relative'>
                ...
                <div className='absolute top-0 left-0 w-full h-full flex flex-col text-white  justify-center z-10 items-center text-center'>
                    ...
                    <p className='max-w-[314px] md:max-w-lg text-center mt-4'>
                        Discover a refined culinary experience with a menu that expertly blends classic elegance with modern innovation. Our offerings feature a carefully curated selection of dishes, prepared with precision and flair. Enjoy the rich flavors and textures that come from using only the finest ingredients. From sophisticated starters to hearty mains, each dish is crafted to delight and satisfy. Join us for an unforgettable dining experience where every meal is a celebration of taste and quality.
                    </p>
                    <div className='flex px-4 mt-10 max-w-lg rounded-md border border-[#f27957] py-2'>
                        ...
                        <AiOutlineSearch size={24} className='text-[#f27957]' />
                    </div>
                </div>


            </div>
            <div className='py-4 px-3 gap-x-3 w-[90%] md:w-[80%] bg-[#f27957] flex items-center rounded-md mt-10 mx-auto'>
                <Link to='/'>
                    <div>
            ...
            <div className='px-10 space-x-2 py-10 text-xl text-[#6C4B3F]'>
                MEAL DETAILS
                <div className='w-8 h-[4px] bg-[#f27957] ' />
            </div>
                ...
                <div className='bg-white rounded-md py-10 px-3'>
                    <div className='flex flex-col md:flex-row  justify-between gap-x-10'>
                        ...
                        <div className='flex-1 flex flex-col '>
                            <h1 className='text-3xl border-b pb-6 border-[#6C4B3F]  text-[#f27957]'>{blogDetailArray[0]?.strMeal}</h1>
                            ...
                            <div className='rounded-md mt-3 bg-[#f27957] px-2 py-3'>
