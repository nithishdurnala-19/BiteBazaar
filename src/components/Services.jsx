        ...
        <main className='px-4 md:px-10 py-6 mt-10 text-[#6C4B3F]'>
            <div className='flex flex-col md:flex-row  justify-between'>
                ...
                <div className='flex-1 mt-6'>
                    ...
                    <div className='grid grid-cols-2 gap-x-16 gap-y-14 mt-10 text-2xl'>
                        {
                            services.map((item) => (
                                <div key={item.id} className='flex items-center gap-x-3'>
                                    <div className='flex items-center justify-center w-8 md:w-12 h-8 md:h-12 rounded-full border border-[#f27957] border-dotted'>
                    ...
                    <Link to='/about'>
                        <button className='flex mx-auto mt-6 px-6 py-3 bg-[#f27957] rounded-[10px]'>About Us
                        </button>
                    </Link>
                </div>
            </div>
