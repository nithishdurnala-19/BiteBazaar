        ...
        <main className='py-10 px-4 md:px-10 rounded-md'>
            <div className='flex items-center justify-between text-xl'>
                ...
                <div className='flex items-center gap-x-3'>
                    ...
                    <div onClick={handlePrev} className='w-8 flex items-center justify-center text-[#313235] text-2xl h-8 rounded-full border-2 border-[#f27957]'>
                        <AiOutlineArrowLeft size={22} />
                    </div>
                    <div onClick={handleNext} className='w-8 flex items-center justify-center text-[#313235] text-2xl h-8 rounded-full border-2 border-[#f27957]'>
                        ...
                        popular.map((item) => (
                            <div key={item.id} className={`${cI === item.id ? 'w-full px-12 py-4 rounded-md bg-white scroll-snap-align-center' : 'hidden'}`}>
                                ...
                                <div className='flex py-4 items-center justify-between'>
                                    ...
                                    <button className='px-2 py-2 bg-[#f27957] rounded-[10px]'>Add to Cart</button>
                                </div>
                            </div>
                        ))
                    }
