        ...
        <div className='mt-24 px-4 md:px-10 py-4'>
            ...
            <div className='flex flex-col md:flex-row '>
                <div className='flex-1'>
                    ...
                    <h1 className='text-5xl md:text-6xl leading-snug text-center md:text-left'>Made with <br className='hidden md:flex' />
                        your love 😍</h1>
                    <p className='text-[#6C4B3F] my-6 text-center md:text-left'>known for best food </p>
                    <div className='flex justify-center md:justify-start items-center gap-x-3'>
                        <div><button className='px-6 bg-[#f27957] py-2 rounded-lg '>Find love you need</button></div>
                        <div className='hidden md:flex px-4 flex-1 max-w-[400px] rounded-md border border-[#f27957] py-2'>
