        ...
        <footer className='mt-16 py-6 px-4 md:px-10 '>
            <div >
                <div className='flex border-b py-4 border-[#6C4B3F] items-center gap-x-3'>
                    ...
                    <h1 className='text-[25px] font-[900]  text-[#313235]'>
                        BiteBazaar</h1>
                </div>
                <div className='grid md:grid-cols-5 mt-10'>
                    <div className='col-span-2 '>
                        ...
                        <div className='flex px-4 md:px-20 gap-x-2 items-center mt-8 text-[#6C4B3F]'>
                            ...
                            <div className='w-12 flex cursor-pointer items-center justify-center text-2xl h-10 rounded-full bg-[#f27957] '>
                                <AiOutlineArrowRight size={28} />
                            </div>
                        </div>
                        <div className='flex text-[#6C4B3F] mt-2 justify-center items-center gap-x-2'>
                            <div className='w-10 flex items-center justify-center text-2xl h-10 rounded-full border-[#6C4B3F] border-2 cursor-pointer hover:scale-75 hover:border-none hover:bg-[#f27957] transition duration-500 ease-in'>
                                <BsFacebook size={20} />
                            </div>
                            <div className='w-10 flex items-center justify-center text-2xl h-10 rounded-full border-[#6C4B3F] border-2 cursor-pointer hover:scale-75 hover:border-none hover:bg-[#f27957] transition duration-500 ease-in'>
