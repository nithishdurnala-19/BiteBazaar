        ...
        <main className='mt-10 py-8 px-6 md:px-10 text-[#6C4B3F] '>
            <div className='flex flex-col md:flex-row md:justify-between md:items-center'>
                <div className='flex-1 w-full'>
                    ...
                    <button className='px-2 py-3 mb-6 md:mb-0 flex mx-auto md:mx-0 bg-[#f27957] rounded-[10px] mt-10'>Make Reservation</button>
                </div>
                <div className='flex-1 flex justify-center md:justify-start px-4'>
                    <motion.div
                        ...
                        transition={{ duration: 5, ease: 'linear', repeat: Infinity, repeatDelay: 0 }} className='bg-[#f27957] relative justify-center flex items-center  w-[300px] h-[300px] md:w-[500px]  md:h-[500px] rounded-full'>
