            ...
            <div className='flex flex-col md:flex-row md:justify-between bg-[#FFF7EC] text-[#6C4B3F rounded-[16px] py-4 md:pt-32 px-3 md:px-28'>
                <div className='flex-1'>
                    ...
                    <div className='flex flex-col gap-y-3 md:gap-y-0 md:flex-row gap-x-3 mt-6'>
                        <div className='flex-1  flex items-center rounded-[32px] gap-x-2 py-3 px-10 md:px-6 md:py-2 bg-[#f27957] cursor-pointer hover:scale-105 transition duration-500 ease-in'>
                        ...
                        <div className='flex-1 flex items-center rounded-[32px] gap-x-2 px-10 md:px-6 py-3 border-2 border-[#f27957] cursor-pointer  hover:scale-105 transition duration-500 ease-in'>
